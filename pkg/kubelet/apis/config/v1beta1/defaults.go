...
func SetDefaults_KubeletConfiguration(obj *kubeletconfigv1beta1.KubeletConfiguration) {
	...
	if obj.ExternalHealthzPort == nil {
		obj.ExternalHealthzPort = utilpointer.Int32Ptr(0)
	}
	if obj.ExternalHealthzPeriod == zeroDuration {
		obj.ExternalHealthzPeriod = metav1.Duration{Duration: 10 * time.Second}
	}
}
